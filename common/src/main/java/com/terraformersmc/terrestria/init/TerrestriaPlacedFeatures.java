...
public class TerrestriaPlacedFeatures {
	...
	public static final RegistryKey<PlacedFeature> BLACK_BAMBOO_HILLY = createRegistryKey("black_bamboo_hilly");
	...
	public static void populate(FabricDynamicRegistryProvider.Entries entries) {
		...
		entries.add(BLACK_BAMBOO_HILLY, placeFeature(entries, TerrestriaConfiguredFeatures.BLACK_BAMBOO_SOME_PODZOL,
			NoiseBasedCountPlacementModifier.of(160, 80.0, 0.3),
			SquarePlacementModifier.of(),
			SurfaceLevelFilterPlacementModifier.of(Heightmap.Type.WORLD_SURFACE, 80, 320),
			PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP));
